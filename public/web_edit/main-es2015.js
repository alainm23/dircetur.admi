...
class HeaderComponent {
    constructor(sidebarService, menuService, themeService, userService, layoutService, breakpointService, cookieService, auth) {
...
const ɵ0 = () => __webpack_require__.e(/*! import() | pages-pages-module-ngfactory */ "pages-pages-module-ngfactory").then(__webpack_require__.bind(null, /*! ./pages/pages.module.ngfactory */ "./src/app/pages/pages.module.ngfactory.js"))
...
class AppComponent {
    constructor(analytics, auth, database, router) {
...
/* harmony import */ var _nebular_theme__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @nebular/theme */ "./node_modules/@nebular/theme/fesm2015/index.js");
...
/* harmony import */ var _nebular_auth__WEBPACK_IMPORTED_MODULE_68__ = __webpack_require__(/*! @nebular/auth */ "./node_modules/@nebular/auth/fesm2015/index.js");
/* harmony import */ var _nebular_security__WEBPACK_IMPORTED_MODULE_69__ = __webpack_require__(/*! @nebular/security */ "./node_modules/@nebular/security/fesm2015/index.js");
...
/* harmony import */ var ngx_cookie_service__WEBPACK_IMPORTED_MODULE_75__ = __webpack_require__(/*! ngx-cookie-service */ "./node_modules/ngx-cookie-service/ngx-cookie-service.js");
...
/* harmony import */ var _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_78__ = __webpack_require__(/*! @angular/cdk/portal */ "./node_modules/@angular/cdk/esm2015/portal.js");
/* harmony import */ var _nebular_eva_icons__WEBPACK_IMPORTED_MODULE_79__ = __webpack_require__(/*! @nebular/eva-icons */ "./node_modules/@nebular/eva-icons/fesm2015/index.js");
...
/* harmony import */ var _ckeditor_ckeditor5_angular__WEBPACK_IMPORTED_MODULE_83__ = __webpack_require__(/*! @ckeditor/ckeditor5-angular */ "./node_modules/@ckeditor/ckeditor5-angular/fesm2015/ckeditor-ckeditor5-angular.js");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes}
...
class ViajeProgramadoPersonasComponent {
    constructor() { }
    ngOnInit() {
    }
}
...
class ViajeProgramadoPersonasModule {
}
...
class LoginComponent {
    constructor(auth, cookieService, database, http, router) {
        this.auth = auth;
        this.cookieService = cookieService;
        this.database = database;
        this.http = http;
    ...
    submit() {
        if (this.loading === false) {
            ...
            this.auth.signInWithEmailAndPassword(this.form.value.email, this.form.value.password)
                ...
                this.database.getUser(user.user.uid).subscribe((data) => {
                    ...
                    if (data.tipo_usuario === "admi" || data.tipo_usuario === "etiquetas") {
                        ...
                        this.http.get("https://api-dirceturcuscoapp.web.app/api/v1/get_custom_token/" + uuid).subscribe((response) => {
...
class AuthGuard {
    constructor(authService, router, database) {
...
class AuthService {
    constructor(afAuth, router, menuService, database) {
        this.afAuth = afAuth;
        this.router = router;
        this.menuService = menuService;
        this.database = database;
    ...
    isLogin() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            return yield this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).toPromise();
        });
    }
    authState() {
...
class DatabaseService {
    ...
    */
    getAgenciaTipo_Clasificaciones() {
        return this.afs.collection('AgenciaTipo_Clasificaciones', ref => ref.orderBy('date_added')).snapshotChanges().map(changes => {
            return changes.map(a => {
                ...
                return Object.assign({ id, edit }, data);
            });
        });
    }
    updateAgenciaTipo_Clasificaciones(data) {
        return this.afs.collection('AgenciaTipo_Clasificaciones').doc(data.id).update({
            nombre: data.nombre
        });
    }
    addAgenciaTipo_Clasificaciones(data) {
    ...
    removeAgenciaTipo_Clasificaciones(data) {
    ...
    getTipos_Turismo() {
        return this.afs.collection('Tipos_Turismo', ref => ref.orderBy('date_added')).snapshotChanges().map(changes => {
            return changes.map(a => {
                ...
                let checked = false;
                const id = a.payload.doc.id;
                return Object.assign({ id, checked }, data);
            });
        });
    }
    updateTipos_Turismo(data) {
        return this.afs.collection('Tipos_Turismo').doc(data.id).update({
            nombre: data.nombre
        });
    }
    addTipos_Turismo(data) {
        let id = this.afs.createId();
    ...
    */
    ...
    updateRestaurante_Clasificaciones(data) {
        return this.afs.collection('Restaurante_Clasificaciones').doc(data.id).update({
            nombre: data.nombre
        });
    }
    addRestaurante_Clasificaciones(data) {
        let id = this.afs.createId();
    ...
    removeRestaurante_Clasificaciones(data) {
    ...
    */
    ...
    removeRestaurante_Categorias(data) {
    ...
    */
    ...
    removeGuia_Asociacion_Colegio(data) {
    ...
    */
    ...
    removeGuia_Centro_Formacion(data) {
    ...
    */
    ...
    removeHotelTipo_Clasificaciones(data) {
    ...
    */
    ...
    /*
      Agencias
    */
    addAgencia(data, representantes) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
    ...
    updateAgencia(data, representantes) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let batch = this.afs.firestore.batch();
            const step_01 = this.afs.collection("Agencias").doc(data.id).ref;
    ...
    */
    ...
    updateHotel(data, representantes) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let batch = this.afs.firestore.batch();
            const step_01 = this.afs.collection("Alojamientos").doc(data.id).ref;
            batch.update(step_01, data);
    ...
    */
    ...
    addRestaurante(data, representantes) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            data.id = this.afs.createId();
            let batch = this.afs.firestore.batch();
    ...
    */
    ...
    removeEventosArtesaniaTipos(data) {
    ...
    */
    ...
    updateEvento(data, fecha_antigua) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let batch = this.afs.firestore.batch();
            const step_01 = this.afs.collection('Eventos').doc(data.id).ref;
            batch.update(step_01, data);
            ...
            if (data.fecha !== fecha_antigua) {
                const step_04 = this.afs.collection('Eventos_Fechas').doc(moment__WEBPACK_IMPORTED_MODULE_7__(fecha_antigua).format('MM')).collection("Eventos").doc(data.id).ref;
                batch.delete(step_04);
                const step_05 = this.afs.collection('Eventos_Fechas').doc(moment__WEBPACK_IMPORTED_MODULE_7__(data.fecha).format('MM')).collection("Eventos").doc(data.id).ref;
                batch.set(step_05, {
                    id: data.id
                });
            }
    ...
    getEventosMes(mes) {
        ...
        return collection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(refReferencias => {
            if (refReferencias.length > 0) {
                return refReferencias.map(refReferencia => {
                    const data = refReferencia.payload.doc.data();
                    return this.getEventoById(data.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(ref => Object.assign({}, { data, ref })));
                });
            }
    ...
    deleteEvento(data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let batch = this.afs.firestore.batch();
            const step_01 = this.afs.collection('Eventos').doc(data.id).ref;
            const step_02 = this.afs.collection('Eventos_Fechas').doc(moment__WEBPACK_IMPORTED_MODULE_7__(data.fecha).format('MM')).collection("Eventos").doc(data.id).ref;
    ...
    */
    ...
    updateEventoArtesania(data, fecha_antigua) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let batch = this.afs.firestore.batch();
            const step_01 = this.afs.collection('Eventos_Artesania').doc(data.id).ref;
            batch.update(step_01, data);
            ...
            if (data.fecha !== fecha_antigua) {
                const step_04 = this.afs.collection('Eventos_Artesania_Fechas').doc(moment__WEBPACK_IMPORTED_MODULE_7__(fecha_antigua).format('MM')).collection("Eventos").doc(data.id).ref;
                batch.delete(step_04);
                const step_05 = this.afs.collection('Eventos_Artesania_Fechas').doc(moment__WEBPACK_IMPORTED_MODULE_7__(data.fecha).format('MM')).collection("Eventos").doc(data.id).ref;
                batch.set(step_05, {
                    id: data.id
                });
            }
    ...
    getEventoArtesaniaById(id) {
        return this.afs.collection('Eventos_Artesania').doc(id).valueChanges();
    }
    getEventosArtesaniaMes(mes) {
        const collection = this.afs.collection('Eventos_Artesania_Fechas').doc(mes).collection("Eventos");
        return collection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(refReferencias => {
            if (refReferencias.length > 0) {
                return refReferencias.map(refReferencia => {
                    const data = refReferencia.payload.doc.data();
                    return this.getEventoArtesaniaById(data.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(ref => Object.assign({}, { data, ref })));
                });
            }
        })).mergeMap(observables => {
            if (observables) {
    ...
    deleteEventoArtesania(data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let batch = this.afs.firestore.batch();
            const step_01 = this.afs.collection('Eventos_Artesania').doc(data.id).ref;
            const step_02 = this.afs.collection('Eventos_Artesania_Fechas').doc(moment__WEBPACK_IMPORTED_MODULE_7__(data.fecha).format('MM')).collection("Eventos").doc(data.id).ref;
    ...
    */
    ...
    addSalidaViajeProgramado(viaje, data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            data.id = this.createId();
            let batch = this.afs.firestore.batch();
            const step_01 = this.afs.collection('Viajes_Programados').doc(viaje.id).collection("Salidas").doc(data.id).ref;
            batch.set(step_01, data);
            const step_02 = this.afs.collection('Viajes_Programados').doc(viaje.id).ref;
            batch.update(step_02, {
                disponible: true
            });
            return yield batch.commit();
