...
var HeaderComponent = /** @class */ (function () {
    function HeaderComponent(sidebarService, menuService, themeService, userService, layoutService, breakpointService, cookieService, auth) {
        ...
        this.userMenu = [{ title: 'Profile', data: { id: 'profile' } }, { title: 'Log out', link: '/login', data: { id: 'logout' } }];
    }
    HeaderComponent.prototype.ngOnInit = function () {
        ...
        this.menuService.onItemClick().subscribe(function (event) {
            if (event.item.data.id === 'profile') {
                ...
                _this.auth.signOut()
                    .then(function () {
                    _this.cookieService.set("dircetur_device_uuid", JSON.stringify({
                        'token': '',
                        'user_type': '',
                        'type': 'signout',
    ...
    ThemeModule.forRoot = function () {
        return {
            ...
            providers: _nebular_theme__WEBPACK_IMPORTED_MODULE_1__["NbThemeModule"].forRoot({
                name: 'default',
            }, [_styles_theme_default__WEBPACK_IMPORTED_MODULE_7__["DEFAULT_THEME"], _styles_theme_cosmic__WEBPACK_IMPORTED_MODULE_8__["COSMIC_THEME"], _styles_theme_corporate__WEBPACK_IMPORTED_MODULE_9__["CORPORATE_THEME"], _styles_theme_dark__WEBPACK_IMPORTED_MODULE_10__["DARK_THEME"]]).providers.slice(),
        };
    };
    return ThemeModule;
}());
...
var ɵ0 = function () { return __webpack_require__.e(/*! import() | pages-pages-module-ngfactory */ "pages-pages-module-ngfactory").then(__webpack_require__.bind(null, /*! ./pages/pages.module.ngfactory */ "./src/app/pages/pages.module.ngfactory.js"))
...
var AppComponent = /** @class */ (function () {
    function AppComponent(analytics, auth, database, router) {
...
/* harmony import */ var _dialogs_viaje_programado_personas_viaje_programado_personas_component_ngfactory__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./dialogs/viaje-programado-personas/viaje-programado-personas.component.ngfactory */ "./src/app/dialogs/viaje-programado-personas/viaje-programado-personas.component.ngfactory.js");
...
/* harmony import */ var _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! @angular/fire/firestore */ "./node_modules/@angular/fire/firestore/index.js");
...
/* harmony import */ var _core_mock_users_service__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./@core/mock/users.service */ "./src/app/@core/mock/users.service.ts");
/* harmony import */ var _core_mock_electricity_service__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./@core/mock/electricity.service */ "./src/app/@core/mock/electricity.service.ts");
/* harmony import */ var _core_mock_smart_table_service__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! ./@core/mock/smart-table.service */ "./src/app/@core/mock/smart-table.service.ts");
/* harmony import */ var _core_mock_periods_service__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./@core/mock/periods.service */ "./src/app/@core/mock/periods.service.ts");
/* harmony import */ var _core_mock_user_activity_service__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./@core/mock/user-activity.service */ "./src/app/@core/mock/user-activity.service.ts");
/* harmony import */ var _core_mock_orders_chart_service__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./@core/mock/orders-chart.service */ "./src/app/@core/mock/orders-chart.service.ts");
/* harmony import */ var _core_mock_profit_chart_service__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./@core/mock/profit-chart.service */ "./src/app/@core/mock/profit-chart.service.ts");
/* harmony import */ var _core_mock_traffic_list_service__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./@core/mock/traffic-list.service */ "./src/app/@core/mock/traffic-list.service.ts");
/* harmony import */ var _core_mock_earning_service__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./@core/mock/earning.service */ "./src/app/@core/mock/earning.service.ts");
/* harmony import */ var _core_data_orders_chart__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./@core/data/orders-chart */ "./src/app/@core/data/orders-chart.ts");
/* harmony import */ var _core_data_profit_chart__WEBPACK_IMPORTED_MODULE_39__ = __webpack_require__(/*! ./@core/data/profit-chart */ "./src/app/@core/data/profit-chart.ts");
/* harmony import */ var _core_mock_orders_profit_chart_service__WEBPACK_IMPORTED_MODULE_40__ = __webpack_require__(/*! ./@core/mock/orders-profit-chart.service */ "./src/app/@core/mock/orders-profit-chart.service.ts");
/* harmony import */ var _core_mock_traffic_bar_service__WEBPACK_IMPORTED_MODULE_41__ = __webpack_require__(/*! ./@core/mock/traffic-bar.service */ "./src/app/@core/mock/traffic-bar.service.ts");
/* harmony import */ var _core_mock_profit_bar_animation_chart_service__WEBPACK_IMPORTED_MODULE_42__ = __webpack_require__(/*! ./@core/mock/profit-bar-animation-chart.service */ "./src/app/@core/mock/profit-bar-animation-chart.service.ts");
/* harmony import */ var _core_mock_temperature_humidity_service__WEBPACK_IMPORTED_MODULE_43__ = __webpack_require__(/*! ./@core/mock/temperature-humidity.service */ "./src/app/@core/mock/temperature-humidity.service.ts");
/* harmony import */ var _core_mock_solar_service__WEBPACK_IMPORTED_MODULE_44__ = __webpack_require__(/*! ./@core/mock/solar.service */ "./src/app/@core/mock/solar.service.ts");
/* harmony import */ var _core_mock_traffic_chart_service__WEBPACK_IMPORTED_MODULE_45__ = __webpack_require__(/*! ./@core/mock/traffic-chart.service */ "./src/app/@core/mock/traffic-chart.service.ts");
/* harmony import */ var _core_mock_stats_bar_service__WEBPACK_IMPORTED_MODULE_46__ = __webpack_require__(/*! ./@core/mock/stats-bar.service */ "./src/app/@core/mock/stats-bar.service.ts");
/* harmony import */ var _core_mock_country_order_service__WEBPACK_IMPORTED_MODULE_47__ = __webpack_require__(/*! ./@core/mock/country-order.service */ "./src/app/@core/mock/country-order.service.ts");
/* harmony import */ var _core_mock_stats_progress_bar_service__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! ./@core/mock/stats-progress-bar.service */ "./src/app/@core/mock/stats-progress-bar.service.ts");
/* harmony import */ var _core_mock_visitors_analytics_service__WEBPACK_IMPORTED_MODULE_49__ = __webpack_require__(/*! ./@core/mock/visitors-analytics.service */ "./src/app/@core/mock/visitors-analytics.service.ts");
/* harmony import */ var _core_mock_security_cameras_service__WEBPACK_IMPORTED_MODULE_50__ = __webpack_require__(/*! ./@core/mock/security-cameras.service */ "./src/app/@core/mock/security-cameras.service.ts");
/* harmony import */ var _core_data_users__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! ./@core/data/users */ "./src/app/@core/data/users.ts");
/* harmony import */ var _core_data_electricity__WEBPACK_IMPORTED_MODULE_52__ = __webpack_require__(/*! ./@core/data/electricity */ "./src/app/@core/data/electricity.ts");
/* harmony import */ var _core_data_smart_table__WEBPACK_IMPORTED_MODULE_53__ = __webpack_require__(/*! ./@core/data/smart-table */ "./src/app/@core/data/smart-table.ts");
/* harmony import */ var _core_data_user_activity__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(/*! ./@core/data/user-activity */ "./src/app/@core/data/user-activity.ts");
/* harmony import */ var _core_data_traffic_list__WEBPACK_IMPORTED_MODULE_55__ = __webpack_require__(/*! ./@core/data/traffic-list */ "./src/app/@core/data/traffic-list.ts");
/* harmony import */ var _core_data_earning__WEBPACK_IMPORTED_MODULE_56__ = __webpack_require__(/*! ./@core/data/earning */ "./src/app/@core/data/earning.ts");
/* harmony import */ var _core_data_orders_profit_chart__WEBPACK_IMPORTED_MODULE_57__ = __webpack_require__(/*! ./@core/data/orders-profit-chart */ "./src/app/@core/data/orders-profit-chart.ts");
/* harmony import */ var _core_data_traffic_bar__WEBPACK_IMPORTED_MODULE_58__ = __webpack_require__(/*! ./@core/data/traffic-bar */ "./src/app/@core/data/traffic-bar.ts");
/* harmony import */ var _core_data_profit_bar_animation_chart__WEBPACK_IMPORTED_MODULE_59__ = __webpack_require__(/*! ./@core/data/profit-bar-animation-chart */ "./src/app/@core/data/profit-bar-animation-chart.ts");
/* harmony import */ var _core_data_temperature_humidity__WEBPACK_IMPORTED_MODULE_60__ = __webpack_require__(/*! ./@core/data/temperature-humidity */ "./src/app/@core/data/temperature-humidity.ts");
/* harmony import */ var _core_data_solar__WEBPACK_IMPORTED_MODULE_61__ = __webpack_require__(/*! ./@core/data/solar */ "./src/app/@core/data/solar.ts");
/* harmony import */ var _core_data_traffic_chart__WEBPACK_IMPORTED_MODULE_62__ = __webpack_require__(/*! ./@core/data/traffic-chart */ "./src/app/@core/data/traffic-chart.ts");
/* harmony import */ var _core_data_stats_bar__WEBPACK_IMPORTED_MODULE_63__ = __webpack_require__(/*! ./@core/data/stats-bar */ "./src/app/@core/data/stats-bar.ts");
/* harmony import */ var _core_data_country_order__WEBPACK_IMPORTED_MODULE_64__ = __webpack_require__(/*! ./@core/data/country-order */ "./src/app/@core/data/country-order.ts");
/* harmony import */ var _core_data_stats_progress_bar__WEBPACK_IMPORTED_MODULE_65__ = __webpack_require__(/*! ./@core/data/stats-progress-bar */ "./src/app/@core/data/stats-progress-bar.ts");
/* harmony import */ var _core_data_visitors_analytics__WEBPACK_IMPORTED_MODULE_66__ = __webpack_require__(/*! ./@core/data/visitors-analytics */ "./src/app/@core/data/visitors-analytics.ts");
/* harmony import */ var _core_data_security_cameras__WEBPACK_IMPORTED_MODULE_67__ = __webpack_require__(/*! ./@core/data/security-cameras */ "./src/app/@core/data/security-cameras.ts");
/* harmony import */ var _nebular_auth__WEBPACK_IMPORTED_MODULE_68__ = __webpack_require__(/*! @nebular/auth */ "./node_modules/@nebular/auth/fesm5/index.js");
/* harmony import */ var _nebular_security__WEBPACK_IMPORTED_MODULE_69__ = __webpack_require__(/*! @nebular/security */ "./node_modules/@nebular/security/fesm5/index.js");
/* harmony import */ var _core_core_module__WEBPACK_IMPORTED_MODULE_70__ = __webpack_require__(/*! ./@core/core.module */ "./src/app/@core/core.module.ts");
/* harmony import */ var _core_utils_analytics_service__WEBPACK_IMPORTED_MODULE_71__ = __webpack_require__(/*! ./@core/utils/analytics.service */ "./src/app/@core/utils/analytics.service.ts");
/* harmony import */ var _core_utils_layout_service__WEBPACK_IMPORTED_MODULE_72__ = __webpack_require__(/*! ./@core/utils/layout.service */ "./src/app/@core/utils/layout.service.ts");
/* harmony import */ var _core_utils_player_service__WEBPACK_IMPORTED_MODULE_73__ = __webpack_require__(/*! ./@core/utils/player.service */ "./src/app/@core/utils/player.service.ts");
/* harmony import */ var _core_utils_state_service__WEBPACK_IMPORTED_MODULE_74__ = __webpack_require__(/*! ./@core/utils/state.service */ "./src/app/@core/utils/state.service.ts");
/* harmony import */ var ngx_cookie_service__WEBPACK_IMPORTED_MODULE_75__ = __webpack_require__(/*! ngx-cookie-service */ "./node_modules/ngx-cookie-service/ngx-cookie-service.es5.js");
...
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_77__ = __webpack_require__(/*! ./login/login.component */ "./src/app/login/login.component.ts");
/* harmony import */ var _angular_cdk_portal__WEBPACK_IMPORTED_MODULE_78__ = __webpack_require__(/*! @angular/cdk/portal */ "./node_modules/@angular/cdk/esm5/portal.es5.js");
/* harmony import */ var _nebular_eva_icons__WEBPACK_IMPORTED_MODULE_79__ = __webpack_require__(/*! @nebular/eva-icons */ "./node_modules/@nebular/eva-icons/fesm5/index.js");
/* harmony import */ var _theme_theme_module__WEBPACK_IMPORTED_MODULE_80__ = __webpack_require__(/*! ./@theme/theme.module */ "./src/app/@theme/theme.module.ts");
/* harmony import */ var _login_login_module__WEBPACK_IMPORTED_MODULE_81__ = __webpack_require__(/*! ./login/login.module */ "./src/app/login/login.module.ts");
/* harmony import */ var _dialogs_viaje_programado_personas_viaje_programado_personas_module__WEBPACK_IMPORTED_MODULE_82__ = __webpack_require__(/*! ./dialogs/viaje-programado-personas/viaje-programado-personas.module */ "./src/app/dialogs/viaje-programado-personas/viaje-programado-personas.module.ts");
/* harmony import */ var _ckeditor_ckeditor5_angular__WEBPACK_IMPORTED_MODULE_83__ = __webpack_require__(/*! @ckeditor/ckeditor5-angular */ "./node_modules/@ckeditor/ckeditor5-angular/fesm5/ckeditor-ckeditor5-angular.js");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes}
...
/* harmony import */ var _angular_common_locales_es_PE__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common/locales/es-PE */ "./node_modules/@angular/common/locales/es-PE.js");
/* harmony import */ var _angular_common_locales_es_PE__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_angular_common_locales_es_PE__WEBPACK_IMPORTED_MODULE_1__);
// Languaje


Object(_angular_common__WEBPACK_IMPORTED_MODULE_0__["registerLocaleData"])(_angular_common_locales_es_PE__WEBPACK_IMPORTED_MODULE_1___default.a);
...
/***/ "./src/app/dialogs/viaje-programado-personas/viaje-programado-personas.component.ngfactory.js":
/*!****************************************************************************************************!*\
  !*** ./src/app/dialogs/viaje-programado-personas/viaje-programado-personas.component.ngfactory.js ***!
  \****************************************************************************************************/
/*! exports provided: RenderType_ViajeProgramadoPersonasComponent, View_ViajeProgramadoPersonasComponent_0, View_ViajeProgramadoPersonasComponent_Host_0, ViajeProgramadoPersonasComponentNgFactory */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RenderType_ViajeProgramadoPersonasComponent", function() { return RenderType_ViajeProgramadoPersonasComponent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_ViajeProgramadoPersonasComponent_0", function() { return View_ViajeProgramadoPersonasComponent_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "View_ViajeProgramadoPersonasComponent_Host_0", function() { return View_ViajeProgramadoPersonasComponent_Host_0; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViajeProgramadoPersonasComponentNgFactory", function() { return ViajeProgramadoPersonasComponentNgFactory; });
/* harmony import */ var _viaje_programado_personas_component_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./viaje-programado-personas.component.scss.shim.ngstyle */ "./src/app/dialogs/viaje-programado-personas/viaje-programado-personas.component.scss.shim.ngstyle.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _viaje_programado_personas_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./viaje-programado-personas.component */ "./src/app/dialogs/viaje-programado-personas/viaje-programado-personas.component.ts");
/**
 * @fileoverview This file was generated by the Angular template compiler. Do not edit.
 *
 * @suppress {suspiciousCode,uselessCode,missingProperties,missingOverride,checkTypes}
...
var styles_ViajeProgramadoPersonasComponent = [_viaje_programado_personas_component_scss_shim_ngstyle__WEBPACK_IMPORTED_MODULE_0__["styles"]];
var RenderType_ViajeProgramadoPersonasComponent = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵcrt"]({ encapsulation: 0, styles: styles_ViajeProgramadoPersonasComponent, data: {} });

function View_ViajeProgramadoPersonasComponent_0(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 11, "div", [["class", "card"], ["style", "width: 18rem;"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](1, 0, null, null, 10, "div", [["class", "card-body"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](2, 0, null, null, 1, "h5", [["class", "card-title"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["Card title"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](4, 0, null, null, 1, "h6", [["class", "card-subtitle mb-2 text-muted"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["Card subtitle"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](6, 0, null, null, 1, "p", [["class", "card-text"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["Some quick example text to build on the card title and make up the bulk of the card's content."])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](8, 0, null, null, 1, "a", [["class", "card-link"], ["href", "#"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["Card link"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](10, 0, null, null, 1, "a", [["class", "card-link"], ["href", "#"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["Another link"]))], null, null); }
function View_ViajeProgramadoPersonasComponent_Host_0(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 1, "ngx-viaje-programado-personas", [], null, null, null, View_ViajeProgramadoPersonasComponent_0, RenderType_ViajeProgramadoPersonasComponent)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](1, 114688, null, 0, _viaje_programado_personas_component__WEBPACK_IMPORTED_MODULE_2__["ViajeProgramadoPersonasComponent"], [], null, null)], function (_ck, _v) { _ck(_v, 1, 0); }, null); }
var ViajeProgramadoPersonasComponentNgFactory = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵccf"]("ngx-viaje-programado-personas", _viaje_programado_personas_component__WEBPACK_IMPORTED_MODULE_2__["ViajeProgramadoPersonasComponent"], View_ViajeProgramadoPersonasComponent_Host_0, {}, {}, []);



/***/ }),

/***/ "./src/app/dialogs/viaje-programado-personas/viaje-programado-personas.component.scss.shim.ngstyle.js":
/*!************************************************************************************************************!*\
  !*** ./src/app/dialogs/viaje-programado-personas/viaje-programado-personas.component.scss.shim.ngstyle.js ***!
  \************************************************************************************************************/
 ...
 * tslint:disable
 */ 
var styles = ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2RpYWxvZ3MvdmlhamUtcHJvZ3JhbWFkby1wZXJzb25hcy92aWFqZS1wcm9ncmFtYWRvLXBlcnNvbmFzLmNvbXBvbmVudC5zY3NzIn0= */"];



/***/ }),

/***/ "./src/app/dialogs/viaje-programado-personas/viaje-programado-personas.component.ts":
/*!******************************************************************************************!*\
  !*** ./src/app/dialogs/viaje-programado-personas/viaje-programado-personas.component.ts ***!
  \******************************************************************************************/
/*! exports provided: ViajeProgramadoPersonasComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViajeProgramadoPersonasComponent", function() { return ViajeProgramadoPersonasComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");

var ViajeProgramadoPersonasComponent = /** @class */ (function () {
    function ViajeProgramadoPersonasComponent() {
    }
    ViajeProgramadoPersonasComponent.prototype.ngOnInit = function () {
    };
    return ViajeProgramadoPersonasComponent;
}());
...
/***/ "./src/app/dialogs/viaje-programado-personas/viaje-programado-personas.module.ts":
/*!***************************************************************************************!*\
  !*** ./src/app/dialogs/viaje-programado-personas/viaje-programado-personas.module.ts ***!
  \***************************************************************************************/
/*! exports provided: ViajeProgramadoPersonasModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ViajeProgramadoPersonasModule", function() { return ViajeProgramadoPersonasModule; });
var ViajeProgramadoPersonasModule = /** @class */ (function () {
    function ViajeProgramadoPersonasModule() {
    }
    return ViajeProgramadoPersonasModule;
}());
...
function View_LoginComponent_1(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 1, "div", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["Ingresar"]))], null, null); }
function View_LoginComponent_2(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 2, "div", [["class", "spinner-border"], ["role", "status"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](1, 0, null, null, 1, "span", [["class", "sr-only"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["Loading..."]))], null, null); }
function View_LoginComponent_0(_l) { return _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵvid"](0, [(_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](0, 0, null, null, 34, "div", [["class", "container"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](1, 0, null, null, 33, "div", [["class", "card login-main"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](2, 0, null, null, 32, "form", [["novalidate", ""]], [[2, "ng-untouched", null], [2, "ng-touched", null], [2, "ng-pristine", null], [2, "ng-dirty", null], [2, "ng-valid", null], [2, "ng-invalid", null], [2, "ng-pending", null]], [[null, "ngSubmit"], [null, "submit"], [null, "reset"]], function (_v, en, $event) { var ad = true; var _co = _v.component; if (("submit" === en)) {
        ...
        ad = (pd_2 && ad);
    } return ad; }, null, null)), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](3, 16384, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ɵangular_packages_forms_forms_z"], [], null, null), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](4, 540672, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroupDirective"], [[8, null], [8, null]], { form: [0, "form"] }, { ngSubmit: "ngSubmit" }), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵprd"](2048, null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ControlContainer"], null, [_angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroupDirective"]]), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵdid"](6, 16384, null, 0, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["NgControlStatusGroup"], [[4, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["ControlContainer"]]], null, null), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](7, 0, null, null, 5, "div", [["class", "row align-items-center justify-content-center"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](8, 0, null, null, 2, "div", [["class", "col-6 align-self-center"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](9, 0, null, null, 1, "b", [["class", "text-center"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵted"](-1, null, ["Dircetur | Administrador"])), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](11, 0, null, null, 1, "div", [["class", "col-6 align-self-center"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](12, 0, null, null, 0, "img", [["class", "logo"], ["src", "https://firebasestorage.googleapis.com/v0/b/dirceturcuscoapp.appspot.com/o/PaginaWeb%2Fhome%2Fhome_imagen_titulo?alt=media&token=6dace059-5d6d-4a20-837d-18441595005f"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](13, 0, null, null, 0, "br", [], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](14, 0, null, null, 6, "div", [["class", "input-group"]], null, null, null, null, null)), (_l()(), _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵeld"](15, 0, null, null, 5, "input", [["class", "form-control"], ["formControlName", "email"], ["placeholder", "Correo electronico"], ["type", "text"]], [[2, "ng-untouched", null], [2, "ng-touched", null], [2, "ng-pristine", null], [2, "ng-dirty", null], [2, "ng-valid", null], [2, "ng-invalid", null], [2, "ng-pending", null]], [[null, "input"], [null, "blur"], [null, "compositionstart"], [null, "compositionend"]], function (_v, en, $event) { var ad = true; if (("input" === en)) {
 ...
 * tslint:disable
 */ 
var styles = [".main-container[_ngcontent-%COMP%] {\n  margin-top: 25px;\n  margin-left: 25px;\n  margin-right: 25px;\n  margin-bottom: 25px; }\n\n.navbar-main[_ngcontent-%COMP%] {\n  margin-top: 25px; }\n\n.login-main[_ngcontent-%COMP%] {\n  position: fixed;\n  width: 50%;\n  top: 50%;\n  left: 50%;\n  \n  -webkit-transform: translate(-50%, -50%);\n          transform: translate(-50%, -50%); }\n\n.fecha-container[_ngcontent-%COMP%] {\n  width: 300px; }\n\n.color[_ngcontent-%COMP%] {\n  background-color: red; }\n\n.avatar[_ngcontent-%COMP%] {\n  width: 48px;\n  height: 48px;\n  border-radius: 150px; }\n\n.vertical[_ngcontent-%COMP%] {\n  align-items: center;\n  justify-content: center; }\n\n.card[_ngcontent-%COMP%] {\n  \n  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);\n  transition: 0.3s;\n  padding: 1rem;\n  border-radius: 8px; }\n\n\n\n.card[_ngcontent-%COMP%]:hover {\n  box-shadow: 0 8px 16px 0 rgba(0, 0, 0, 0.2); }\n\n.logo[_ngcontent-%COMP%] {\n  height: 64px; }\n/*# sourceMappingURL=data:application/json;base64, */"];
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(auth, cookieService, database, http, router) {
        this.auth = auth;
        this.cookieService = cookieService;
        this.database = database;
        this.http = http;
    ...
    LoginComponent.prototype.generateUUID = function () {
        return angular2_uuid__WEBPACK_IMPORTED_MODULE_7__["UUID"].UUID();
    };
    LoginComponent.prototype.submit = function () {
        ...
        if (this.loading === false) {
            ...
            this.auth.signInWithEmailAndPassword(this.form.value.email, this.form.value.password)
                ...
                _this.database.getUser(user.user.uid).subscribe(function (data) {
                    console.log('data', data);
                    if (data.tipo_usuario === "admi" || data.tipo_usuario === "etiquetas") {
                        _this.auth.set_usuario(data);
                        _this.auth.logeado = true;
                        _this.router.navigate(['pages/home']);
                        // Create user token
                        var uuid = _this.generateUUID();
                        _this.http.get("https://api-dirceturcuscoapp.web.app/api/v1/get_custom_token/" + uuid).subscribe(function (response) {
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(authService, router, database) {
    ...
    AuthGuard.prototype.canActivate = function () {
        ...
        return this.authService.isLogin()
            .then(function (user) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var user_data;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!user) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.database.getUser(user.uid).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["first"])()).toPromise()];
                    case 1:
                        user_data = _a.sent();
    ...
    AuthGuard.ngInjectableDef = _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineInjectable"]({ factory: function AuthGuard_Factory() { return new AuthGuard(_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵinject"](_services_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]), _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_1__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵinject"](_services_database_service__WEBPACK_IMPORTED_MODULE_3__["DatabaseService"])); }, token: AuthGuard, providedIn: "root" });
    return AuthGuard;
}());
...
var AuthService = /** @class */ (function () {
    function AuthService(afAuth, router, menuService, database) {
        this.afAuth = afAuth;
        this.router = router;
        this.menuService = menuService;
        this.database = database;
    ...
    AuthService.prototype.initMenu = function () {
        this.menu = [
            {
                acceso: ['admi'],
                title: 'Principal',
            ...
            {
                acceso: ['admi', 'etiquetas'],
                title: 'Administrar etiquetas web',
                icon: 'edit-outline',
                url: 'https://web-edit-dirceturcuscoapp.web.app'
            },
            {
                acceso: ['admi', 'etiquetas'],
                title: 'Pagina Web',
            ...
            {
                acceso: ['admi'],
                title: 'Calendario Artesania',
                icon: 'calendar',
                children: [
                    {
                        title: 'Agregar Eventos',
                        link: '/pages/calendario-artesania/agregar-eventos',
                    },
                    {
                        title: 'Listar Eventos',
                        link: '/pages/calendario-artesania/ver-eventos',
                    },
                    {
                        title: 'Gestionar Tipos',
                        link: '/pages/calendario-artesania/editar-tipos',
                    }
                ]
            },
            {
            ...
            },
            {
                ...
                children: [
                    {
                        title: 'Agregar Viaje Programado',
                        link: '/pages/viaje-programado/agregar-viaje-programado',
                    },
                    {
                        title: 'Listar Viaje Programado',
                        link: '/pages/viaje-programado/listar-viaje-programado',
                    }
                ]
            },
            {
    ...
    AuthService.prototype.isLogin = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.afAuth.authState.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["first"])()).toPromise()];
    ...
    AuthService.prototype.set_usuario = function (user) {
        var _this = this;
        this.usuario = user;
        this.menu.forEach(function (item) {
            if (item.acceso.includes(_this.usuario.tipo_usuario) === false) {
                item.hidden = true;
            }
        });
    };
    AuthService.ngInjectableDef = _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵdefineInjectable"]({ factory: function AuthService_Factory() { return new AuthService(_angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵinject"](_angular_fire_auth__WEBPACK_IMPORTED_MODULE_1__["AngularFireAuth"]), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵinject"](_angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"]), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵinject"](_nebular_theme__WEBPACK_IMPORTED_MODULE_4__["NbMenuService"]), _angular_core__WEBPACK_IMPORTED_MODULE_6__["ɵɵinject"](_services_database_service__WEBPACK_IMPORTED_MODULE_2__["DatabaseService"])); }, token: AuthService, providedIn: "root" });
    return AuthService;
}());
...
var DatabaseService = /** @class */ (function () {
    ...
    DatabaseService.prototype.getUser = function (id) {
        return this.afs.collection("Users").doc(id).valueChanges();
    };
    /*
      Tipo de Agencias
    */
    DatabaseService.prototype.getAgenciaTipo_Clasificaciones = function () {
        return this.afs.collection('AgenciaTipo_Clasificaciones', function (ref) { return ref.orderBy('date_added'); }).snapshotChanges().map(function (changes) {
            return changes.map(function (a) {
                var data = a.payload.doc.data();
                var edit = false;
                var id = a.payload.doc.id;
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ id: id, edit: edit }, data);
            });
        });
    };
    DatabaseService.prototype.updateAgenciaTipo_Clasificaciones = function (data) {
        return this.afs.collection('AgenciaTipo_Clasificaciones').doc(data.id).update({
            nombre: data.nombre
        });
    };
    DatabaseService.prototype.addAgenciaTipo_Clasificaciones = function (data) {
    ...
    DatabaseService.prototype.removeAgenciaTipo_Clasificaciones = function (data) {
        return this.afs.collection('AgenciaTipo_Clasificaciones').doc(data.id).delete();
    };
    /*
      Tipos_Turismo
    */
    DatabaseService.prototype.getTipos_Turismo = function () {
        return this.afs.collection('Tipos_Turismo', function (ref) { return ref.orderBy('date_added'); }).snapshotChanges().map(function (changes) {
            return changes.map(function (a) {
                var data = a.payload.doc.data();
                var checked = false;
                var id = a.payload.doc.id;
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"]({ id: id, checked: checked }, data);
            });
        });
    };
    DatabaseService.prototype.updateTipos_Turismo = function (data) {
        return this.afs.collection('Tipos_Turismo').doc(data.id).update({
            nombre: data.nombre
        });
    };
    DatabaseService.prototype.addTipos_Turismo = function (data) {
        var id = this.afs.createId();
    ...
    DatabaseService.prototype.removeTipos_Turismo = function (data) {
        return this.afs.collection('Tipos_Turismo').doc(data.id).delete();
    };
    /*
      Categoria Blogs
    */
    DatabaseService.prototype.getBlog_Categorias = function () {
        return this.afs.collection('Blog_Categorias', function (ref) { return ref.orderBy('date_added'); }).snapshotChanges().map(function (changes) {
            return changes.map(function (a) {
                var data = a.payload.doc.data();
                var edit = false;
                var id = a.payload.doc.id;
    ...
    DatabaseService.prototype.updateBlog_Categorias = function (data) {
        return this.afs.collection('Blog_Categorias').doc(data.id).update({
            nombre: data.nombre
        });
    };
    DatabaseService.prototype.addBlog_Categorias = function (data) {
        var id = this.afs.createId();
    ...
    DatabaseService.prototype.removeBlog_Categorias = function (data) {
        return this.afs.collection('Blog_Categorias').doc(data.id).delete();
    };
    /*
      Restaitantes Clasificacinones
    */
    DatabaseService.prototype.getRestaurante_Clasificaciones2 = function () {
        return this.afs.collection('Restaurante_Clasificaciones', function (ref) { return ref.orderBy('date_added'); }).snapshotChanges().map(function (changes) {
            return changes.map(function (a) {
                var data = a.payload.doc.data();
                var edit = false;
                var id = a.payload.doc.id;
    ...
    DatabaseService.prototype.updateRestaurante_Clasificaciones = function (data) {
        return this.afs.collection('Restaurante_Clasificaciones').doc(data.id).update({
            nombre: data.nombre
        });
    };
    DatabaseService.prototype.addRestaurante_Clasificaciones = function (data) {
        var id = this.afs.createId();
    ...
    DatabaseService.prototype.removeRestaurante_Clasificaciones = function (data) {
        return this.afs.collection('Restaurante_Clasificaciones').doc(data.id).delete();
    };
    /*
      Restaurantes Categorias
    */
    DatabaseService.prototype.getRestaurante_Categorias2 = function () {
        return this.afs.collection('Restaurante_Categorias', function (ref) { return ref.orderBy('date_added'); }).snapshotChanges().map(function (changes) {
            return changes.map(function (a) {
                var data = a.payload.doc.data();
                var edit = false;
                var id = a.payload.doc.id;
    ...
    DatabaseService.prototype.updateRestaurante_Categorias = function (data) {
        return this.afs.collection('Restaurante_Categorias').doc(data.id).update({
            nombre: data.nombre
        });
    };
    DatabaseService.prototype.addRestaurante_Categorias = function (data) {
        var id = this.afs.createId();
    ...
    DatabaseService.prototype.removeRestaurante_Categorias = function (data) {
        return this.afs.collection('Restaurante_Categorias').doc(data.id).delete();
    };
    /*
      Idiomas
    */
    DatabaseService.prototype.getGuia_Idiomas2 = function () {
        return this.afs.collection('Guia_Idiomas', function (ref) { return ref.orderBy('date_added'); }).snapshotChanges().map(function (changes) {
            return changes.map(function (a) {
                var data = a.payload.doc.data();
                var edit = false;
                var id = a.payload.doc.id;
    ...
    DatabaseService.prototype.updateGuia_Idiomas = function (data) {
        return this.afs.collection('Guia_Idiomas').doc(data.id).update({
            nombre: data.nombre
        });
    };
    DatabaseService.prototype.addGuia_Idiomas = function (data) {
        var id = this.afs.createId();
    ...
    DatabaseService.prototype.removeGuia_Idiomas = function (data) {
        return this.afs.collection('Guia_Idiomas').doc(data.id).delete();
    };
    /*
      Asociacion o colegios
    */
    DatabaseService.prototype.getGuia_Asociacion_Colegio = function () {
        return this.afs.collection('Guia_Asociacion_Colegio', function (ref) { return ref.orderBy('date_added'); }).snapshotChanges().map(function (changes) {
            return changes.map(function (a) {
                var data = a.payload.doc.data();
                var edit = false;
                var id = a.payload.doc.id;
    ...
    DatabaseService.prototype.updateGuia_Asociacion_Colegio = function (data) {
        return this.afs.collection('Guia_Asociacion_Colegio').doc(data.id).update({
            nombre: data.nombre
        });
    };
    DatabaseService.prototype.addGuia_Asociacion_Colegio = function (data) {
        var id = this.afs.createId();
    ...
    DatabaseService.prototype.removeGuia_Asociacion_Colegio = function (data) {
        return this.afs.collection('Guia_Asociacion_Colegio').doc(data.id).delete();
    };
    /*
      Centro de formacion
    */
    DatabaseService.prototype.getGuia_Centro_Formacion = function () {
        return this.afs.collection('Guia_Centro_Formacion', function (ref) { return ref.orderBy('date_added'); }).snapshotChanges().map(function (changes) {
            return changes.map(function (a) {
                var data = a.payload.doc.data();
                var edit = false;
                var id = a.payload.doc.id;
    ...
    DatabaseService.prototype.updateGuia_Centro_Formacion = function (data) {
        return this.afs.collection('Guia_Centro_Formacion').doc(data.id).update({
            nombre: data.nombre
        });
    };
    DatabaseService.prototype.addGuia_Centro_Formacion = function (data) {
        var id = this.afs.createId();
    ...
    DatabaseService.prototype.removeGuia_Centro_Formacion = function (data) {
        return this.afs.collection('Guia_Centro_Formacion').doc(data.id).delete();
    };
    /*
      Tipos de Guiado
    */
    DatabaseService.prototype.getGuia_Tipo_Guiado2 = function () {
        return this.afs.collection('Guia_Tipo_Guiado', function (ref) { return ref.orderBy('date_added'); }).snapshotChanges().map(function (changes) {
            return changes.map(function (a) {
                var data = a.payload.doc.data();
                var edit = false;
                var id = a.payload.doc.id;
    ...
    DatabaseService.prototype.updateGuia_Tipo_Guiado = function (data) {
        return this.afs.collection('Guia_Tipo_Guiado').doc(data.id).update({
            nombre: data.nombre
        });
    };
    DatabaseService.prototype.addGuia_Tipo_Guiado = function (data) {
        var id = this.afs.createId();
    ...
    DatabaseService.prototype.removeGuia_Tipo_Guiado = function (data) {
        return this.afs.collection('Guia_Tipo_Guiado').doc(data.id).delete();
    };
    /*
      Provincias
    */
    DatabaseService.prototype.getProvincias = function () {
        return this.afs.collection('Provincias').valueChanges();
    };
    DatabaseService.prototype.getDistritosByProvincias = function (id) {
        return this.afs.collection('Provincias').doc(id).collection('Distritos').valueChanges();
    };
    /*
      Hotel Tios
    */
    DatabaseService.prototype.getHotelTipo_Clasificaciones = function () {
        return this.afs.collection('HotelTipo_Clasificaciones', function (ref) { return ref.orderBy('date_added'); }).snapshotChanges().map(function (changes) {
            return changes.map(function (a) {
                var data = a.payload.doc.data();
                var edit = false;
                var id = a.payload.doc.id;
    ...
    DatabaseService.prototype.updateHotelTipo_Clasificaciones = function (data) {
        return this.afs.collection('HotelTipo_Clasificaciones').doc(data.id).update({
            nombre: data.name
        });
    };
    DatabaseService.prototype.addHotelTipo_Clasificaciones = function (data) {
        var id = this.afs.createId();
    ...
    DatabaseService.prototype.removeHotelTipo_Clasificaciones = function (data) {
        return this.afs.collection('HotelTipo_Clasificaciones').doc(data.id).delete();
    };
    /*
      Verificacion de correos
    */
    DatabaseService.prototype.is_email_valid = function (email) {
        return this.afs.collection('Correos_Usados').doc(email).valueChanges();
    };
    /*
      Agencias
    */
    DatabaseService.prototype.addAgencia = function (data, representantes) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        step_01 = this.afs.collection('Agencias').doc(data.id).ref;
                        batch.set(step_01, data);
                        representantes.forEach(function (r) {
                            r.id = _this.afs.createId();
                            delete r._id;
                            var step = _this.afs.collection('Agencias').doc(data.id).collection('Representantes').doc(r.id).ref;
                            batch.set(step, r);
                        });
    ...
    DatabaseService.prototype.updateAgencia = function (data, representantes) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    case 0:
                        ...
                        representantes.forEach(function (r) {
                            if (r.id === "" || r.id === undefined || r.id === null) {
                                r.id = _this.createId();
                                var stepx = _this.afs.collection('Agencias').doc(data.id).collection("Representantes").doc(r.id).ref;
                                batch.set(stepx, r);
                            }
                            else {
                                var stepx = _this.afs.collection('Agencias').doc(data.id).collection("Representantes").doc(r.id).ref;
    ...
    */
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data.id = this.afs.createId();
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Alojamientos').doc(data.id).ref;
                        batch.set(step_01, data);
                        representantes.forEach(function (r) {
                            r.id = _this.afs.createId();
                            delete r._id;
                            var step = _this.afs.collection('Alojamientos').doc(data.id).collection('Representantes').doc(r.id).ref;
                            batch.set(step, r);
                        });
                        return [4 /*yield*/, batch.commit()];
                    case 1: return [2 /*return*/, _a.sent()];
    ...
    DatabaseService.prototype.updateHotel = function (data, representantes) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        representantes.forEach(function (r) {
                            if (r.id === "" || r.id === undefined || r.id === null) {
                                r.id = _this.createId();
                                var stepx = _this.afs.collection('Alojamientos').doc(data.id).collection("Representantes").doc(r.id).ref;
                                batch.set(stepx, r);
                            }
                            else {
                                var stepx = _this.afs.collection('Alojamientos').doc(data.id).collection("Representantes").doc(r.id).ref;
    ...
    */
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data.id = this.afs.createId();
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Restaurantes').doc(data.id).ref;
                        batch.set(step_01, data);
                        representantes.forEach(function (r) {
                            r.id = _this.afs.createId();
                            delete r._id;
                            var step = _this.afs.collection('Restaurantes').doc(data.id).collection('Representantes').doc(r.id).ref;
                            batch.set(step, r);
                        });
                        return [4 /*yield*/, batch.commit()];
                    case 1: return [2 /*return*/, _a.sent()];
    ...
    DatabaseService.prototype.getRestauranteById = function (id) {
        return this.afs.collection("Restaurantes").doc(id).valueChanges();
    };
    DatabaseService.prototype.getRestauranteByDistritos = function (id1, id2) {
        return this.afs.collection("Provincias").doc(id1).collection("Distritos").doc(id2).collection("Lista_Restaurantes").valueChanges();
    };
    DatabaseService.prototype.getRestauranteRepresentantes = function (id) {
        return this.afs.collection('Restaurantes').doc(id).collection('Representantes').valueChanges();
    };
    DatabaseService.prototype.updateRestaurante = function (data, representantes) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        representantes.forEach(function (r) {
                            if (r.id === "" || r.id === undefined || r.id === null) {
                                r.id = _this.createId();
                                var stepx = _this.afs.collection('Restaurantes').doc(data.id).collection("Representantes").doc(r.id).ref;
                                batch.set(stepx, r);
                            }
                            else {
                                var stepx = _this.afs.collection('Restaurantes').doc(data.id).collection("Representantes").doc(r.id).ref;
    ...
    /*
      Guias
    */
    DatabaseService.prototype.addGuia = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data.id = this.afs.createId();
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Guias').doc(data.id).ref;
                        batch.set(step_01, data);
                        return [4 /*yield*/, batch.commit()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
    ...
    DatabaseService.prototype.getGuia_Idiomas = function () {
        return this.afs.collection('Guia_Idiomas').snapshotChanges().map(function (changes) {
            return changes.map(function (a) {
                var data = a.payload.doc.data();
                var checked = false;
                var id = a.payload.doc.id;
    ...
    DatabaseService.prototype.getGuia_Tipo_Guiado = function () {
        return this.afs.collection('Guia_Tipo_Guiado').snapshotChanges().map(function (changes) {
            return changes.map(function (a) {
                var data = a.payload.doc.data();
                var checked = false;
                var id = a.payload.doc.id;
    ...
    DatabaseService.prototype.getGuiasByDistritos = function (id1, id2) {
        return this.afs.collection("Provincias").doc(id1).collection("Distritos").doc(id2).collection("Lista_Guias").valueChanges();
    };
    DatabaseService.prototype.getGuiaById = function (id) {
        return this.afs.collection('Guias').doc(id).valueChanges();
    };
    DatabaseService.prototype.updateGuia = function (data) {
        return this.afs.collection('Guias').doc(data.id).update(data);
    };
    /*
      Tipo de Agencias
    */
    DatabaseService.prototype.getEventosTipos = function () {
        return this.afs.collection('Eventos_Tipos', function (ref) { return ref.orderBy('date_added'); }).snapshotChanges().map(function (changes) {
            return changes.map(function (a) {
                var data = a.payload.doc.data();
                var edit = false;
                var id = a.payload.doc.id;
    ...
    DatabaseService.prototype.updateEventosTipos = function (data) {
        return this.afs.collection('Eventos_Tipos').doc(data.id).update({
            nombre: data.nombre
        });
    };
    DatabaseService.prototype.addEventosTipos = function (data) {
        data.id = this.afs.createId();
        return this.afs.collection('Eventos_Tipos').doc(data.id).set({
            id: data.id,
            nombre: data,
            date_added: new Date().toISOString()
        });
    };
    DatabaseService.prototype.removeEventosTipos = function (data) {
        return this.afs.collection('Eventos_Tipos').doc(data.id).delete();
    };
    /*
  
    */
    DatabaseService.prototype.getEventosArtesaniaTipos = function () {
        return this.afs.collection('Eventos_Artesania_Tipos', function (ref) { return ref.orderBy('date_added'); }).snapshotChanges().map(function (changes) {
            return changes.map(function (a) {
                var data = a.payload.doc.data();
                var edit = false;
                var id = a.payload.doc.id;
    ...
    DatabaseService.prototype.updateEventosArtesaniaTipos = function (data) {
        return this.afs.collection('Eventos_Artesania_Tipos').doc(data.id).update({
            nombre: data.nombre
        });
    };
    DatabaseService.prototype.addEventosArtesaniaTipos = function (data) {
        data.id = this.afs.createId();
    ...
    DatabaseService.prototype.removeEventosArtesaniaTipos = function (data) {
        return this.afs.collection('Eventos_Artesania_Tipos').doc(data.id).delete();
    };
    /*
      Clasificacion
    */
    DatabaseService.prototype.getEventosCategorias = function () {
        return this.afs.collection('Eventos_Categorias', function (ref) { return ref.orderBy('date_added'); }).snapshotChanges().map(function (changes) {
            return changes.map(function (a) {
                var data = a.payload.doc.data();
                var edit = false;
                var id = a.payload.doc.id;
    ...
    DatabaseService.prototype.updateEventosCategorias = function (data) {
        return this.afs.collection('Eventos_Categorias').doc(data.id).update({
            name: data.name
        });
    };
    DatabaseService.prototype.addEventosCategorias = function (data) {
        data.id = this.afs.createId();
    ...
    DatabaseService.prototype.removeEventosCategorias = function (data) {
        return this.afs.collection('Eventos_Categorias').doc(data.id).delete();
    };
    /*
      Calendario Turisticos
    */
    DatabaseService.prototype.addEvento = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Eventos').doc(data.id).ref;
                        batch.set(step_01, data);
                        return [4 /*yield*/, batch.commit()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
    ...
    DatabaseService.prototype.updateEvento = function (data, fecha_antigua) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01, step_02, step_03, step_04, step_05;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Eventos').doc(data.id).ref;
                        batch.update(step_01, data);
                        step_02 = this.afs.collection('Provincias').doc(data.provincia.id).collection('Lista_Eventos').doc(data.id).ref;
                        ...
                        step_03 = this.afs.collection('Provincias').doc(data.provincia.id).collection('Distritos').doc(data.distrito.id).collection('Lista_Eventos').doc(data.id).ref;
                        ...
                        if (data.fecha !== fecha_antigua) {
                            step_04 = this.afs.collection('Eventos_Fechas').doc(moment__WEBPACK_IMPORTED_MODULE_7__(fecha_antigua).format('MM')).collection("Eventos").doc(data.id).ref;
                            batch.delete(step_04);
                            step_05 = this.afs.collection('Eventos_Fechas').doc(moment__WEBPACK_IMPORTED_MODULE_7__(data.fecha).format('MM')).collection("Eventos").doc(data.id).ref;
                            batch.set(step_05, {
                                id: data.id
                            });
                        }
    ...
    DatabaseService.prototype.getEventos = function () {
        return this.afs.collection('Eventos').valueChanges();
    };
    DatabaseService.prototype.getEventoById = function (id) {
        return this.afs.collection('Eventos').doc(id).valueChanges();
    };
    DatabaseService.prototype.getEventosMes = function (mes) {
        var _this = this;
        var collection = this.afs.collection('Eventos_Fechas').doc(mes).collection("Eventos");
        return collection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (refReferencias) {
            if (refReferencias.length > 0) {
                return refReferencias.map(function (refReferencia) {
                    var data = refReferencia.payload.doc.data();
                    return _this.getEventoById(data.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (ref) { return Object.assign({}, { data: data, ref: ref }); }));
                });
            }
        })).mergeMap(function (observables) {
            if (observables) {
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_5__["combineLatest"])(observables);
            }
            else {
    ...
    DatabaseService.prototype.deleteEvento = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01, step_02, step_03, step_04;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Eventos').doc(data.id).ref;
                        step_02 = this.afs.collection('Eventos_Fechas').doc(moment__WEBPACK_IMPORTED_MODULE_7__(data.fecha).format('MM')).collection("Eventos").doc(data.id).ref;
                        step_03 = this.afs.collection('Provincias').doc(data.provincia.id).collection('Lista_Eventos').doc(data.id).ref;
                        step_04 = this.afs.collection('Provincias').doc(data.provincia.id).collection('Distritos').doc(data.distrito.id).collection('Lista_Eventos').doc(data.id).ref;
    ...
    */
    DatabaseService.prototype.addEventoArtesania = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data.id = this.afs.createId();
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Eventos_Artesania').doc(data.id).ref;
                        batch.set(step_01, data);
                        return [4 /*yield*/, batch.commit()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
    ...
    DatabaseService.prototype.updateEventoArtesania = function (data, fecha_antigua) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01, step_02, step_03, step_04, step_05;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        step_01 = this.afs.collection('Eventos_Artesania').doc(data.id).ref;
                        batch.update(step_01, data);
                        step_02 = this.afs.collection('Provincias').doc(data.provincia.id).collection('Lista_Eventos_Artesania').doc(data.id).ref;
                        batch.update(step_02, {
                            'id': data.id,
                            'titulo': data.titulo,
                            'fecha': data.fecha,
                        ...
                        step_03 = this.afs.collection('Provincias').doc(data.provincia.id).collection('Distritos').doc(data.distrito.id).collection('Lista_Eventos_Artesania').doc(data.id).ref;
                        batch.update(step_03, {
                            'id': data.id,
                            'titulo': data.titulo,
                            'fecha': data.fecha,
                        ...
                        if (data.fecha !== fecha_antigua) {
                            step_04 = this.afs.collection('Eventos_Artesania_Fechas').doc(moment__WEBPACK_IMPORTED_MODULE_7__(fecha_antigua).format('MM')).collection("Eventos").doc(data.id).ref;
                            batch.delete(step_04);
                            step_05 = this.afs.collection('Eventos_Artesania_Fechas').doc(moment__WEBPACK_IMPORTED_MODULE_7__(data.fecha).format('MM')).collection("Eventos").doc(data.id).ref;
                            batch.set(step_05, {
                                id: data.id
                            });
                        }
    ...
    DatabaseService.prototype.getEventosArtesania = function () {
        return this.afs.collection('Eventos_Artesania').valueChanges();
    };
    DatabaseService.prototype.getEventoArtesaniaById = function (id) {
        return this.afs.collection('Eventos_Artesania').doc(id).valueChanges();
    };
    DatabaseService.prototype.getEventosArtesaniaMes = function (mes) {
        var _this = this;
        var collection = this.afs.collection('Eventos_Artesania_Fechas').doc(mes).collection("Eventos");
        return collection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (refReferencias) {
            if (refReferencias.length > 0) {
                return refReferencias.map(function (refReferencia) {
                    var data = refReferencia.payload.doc.data();
                    return _this.getEventoArtesaniaById(data.id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["map"])(function (ref) { return Object.assign({}, { data: data, ref: ref }); }));
                });
            }
        })).mergeMap(function (observables) {
            if (observables) {
    ...
    DatabaseService.prototype.deleteEventoArtesania = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01, step_02, step_03, step_04;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Eventos_Artesania').doc(data.id).ref;
                        step_02 = this.afs.collection('Eventos_Artesania_Fechas').doc(moment__WEBPACK_IMPORTED_MODULE_7__(data.fecha).format('MM')).collection("Eventos").doc(data.id).ref;
                        step_03 = this.afs.collection('Provincias').doc(data.provincia.id).collection('Lista_Eventos_Artesania').doc(data.id).ref;
                        step_04 = this.afs.collection('Provincias').doc(data.provincia.id).collection('Distritos').doc(data.distrito.id).collection('Lista_Eventos_Artesania').doc(data.id).ref;
                        batch.delete(step_01);
                        batch.delete(step_02);
                        batch.delete(step_03);
                        batch.delete(step_04);
    ...
    /*
      Blog
    */
    DatabaseService.prototype.addBlog = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01, step_02;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Blogs').doc(data.id).ref;
                        batch.set(step_01, data);
                        step_02 = this.afs.collection('Blog_Categorias').doc(data.categoria.id).collection("Blogs").doc(data.id).ref;
                        batch.set(step_02, {
                            id: data.id
                        });
                        return [4 /*yield*/, batch.commit()];
    ...
    DatabaseService.prototype.getBlogs = function () {
        return this.afs.collection("Blogs").valueChanges();
    };
    DatabaseService.prototype.getBlogById = function (id) {
        return this.afs.collection("Blogs").doc(id).valueChanges();
    };
    DatabaseService.prototype.updateBlog = function (data, categoria_old) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01, step_02, step_04, step_04;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        batch = this.afs.firestore.batch();
                        ...
                        if (categoria_old !== undefined && categoria_old !== null) {
                            if (data.categoria.id !== categoria_old.id) {
                                step_02 = this.afs.collection("Blog_Categorias").doc(categoria_old.id).collection("Blogs").doc(data.id).ref;
                                batch.delete(step_01);
                                step_04 = this.afs.collection('Blog_Categorias').doc(data.categoria.id).collection("Blogs").doc(data.id).ref;
                                batch.set(step_04, {
                                    id: data.id
                                });
                            }
    ...
    DatabaseService.prototype.deleteBlog = function (item) {
        return this.afs.collection("Blogs").doc(item.id).delete();
    };
    /*
      Circuitosos Turisticos
    */
    DatabaseService.prototype.addCircuito = function (data, dias) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Circuitos_Turisticos').doc(data.id).ref;
                        batch.set(step_01, data);
                        dias.forEach(function (dia) {
                            var stepx = _this.afs.collection('Circuitos_Turisticos').doc(data.id).collection("Dias").doc(dia.id).ref;
                            batch.set(stepx, dia);
                        });
                        return [4 /*yield*/, batch.commit()];
                    case 1: return [2 /*return*/, _a.sent()];
    ...
    DatabaseService.prototype.getCircuitos = function () {
        return this.afs.collection("Circuitos_Turisticos").valueChanges();
    };
    DatabaseService.prototype.deleteCircuito = function (id) {
        return this.afs.collection("Circuitos_Turisticos").doc(id).delete();
    };
    DatabaseService.prototype.getCircuitoById = function (id) {
        return this.afs.collection("Circuitos_Turisticos").doc(id).valueChanges();
    };
    DatabaseService.prototype.updateCircuito = function (data, dias) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    DatabaseService.prototype.getCircuitoDias = function (id) {
        return this.afs.collection("Circuitos_Turisticos").doc(id).collection("Dias").valueChanges();
    };
    // Viaje Programado
    DatabaseService.prototype.addViajeProgramado = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Viajes_Programados').doc(data.id).ref;
                        batch.set(step_01, data);
                        return [4 /*yield*/, batch.commit()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
    ...
    DatabaseService.prototype.updateViajeProgramado = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    DatabaseService.prototype.getViajesProgramados = function () {
        return this.afs.collection('Viajes_Programados').valueChanges();
    };
    DatabaseService.prototype.getViajesProgramadoById = function (id) {
        return this.afs.collection('Viajes_Programados').doc(id).valueChanges();
    };
    DatabaseService.prototype.deleteViajesProgramados = function (id) {
        return this.afs.collection('Viajes_Programados').doc(id).delete();
    };
    // Turismo Rural
    DatabaseService.prototype.addTurismoRural = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Turismo_Rural').doc(data.id).ref;
                        batch.set(step_01, data);
                        return [4 /*yield*/, batch.commit()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
    ...
    DatabaseService.prototype.updateTurismoRural = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    DatabaseService.prototype.getTurismoRural = function () {
        return this.afs.collection('Turismo_Rural').valueChanges();
    };
    DatabaseService.prototype.getTurismoRuralById = function (id) {
        return this.afs.collection('Turismo_Rural').doc(id).valueChanges();
    };
    // Sobre Dircetur
    DatabaseService.prototype.addFuncion = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data.id = this.afs.createId();
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Dircetur_Funciones').doc(data.id).ref;
                        batch.set(step_01, data);
                        return [4 /*yield*/, batch.commit()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
    ...
    DatabaseService.prototype.removeFuncion = function (id) {
        return this.afs.collection('Dircetur_Funciones').doc(id).delete();
    };
    DatabaseService.prototype.updateFuncion = function (data) {
        return this.afs.collection('Dircetur_Funciones').doc(data.id).update(data);
    };
    DatabaseService.prototype.getFunciones = function () {
        return this.afs.collection('Dircetur_Funciones').valueChanges();
    };
    DatabaseService.prototype.addJunta = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data.id = this.afs.createId();
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Dircetur_JuntaDirectiva').doc(data.id).ref;
                        batch.set(step_01, data);
                        return [4 /*yield*/, batch.commit()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
    ...
    DatabaseService.prototype.removeJunta = function (id) {
        return this.afs.collection('Dircetur_JuntaDirectiva').doc(id).delete();
    };
    DatabaseService.prototype.updateJunta = function (data) {
        return this.afs.collection('Dircetur_JuntaDirectiva').doc(data.id).update(data);
    };
    DatabaseService.prototype.getJunta = function () {
        return this.afs.collection('Dircetur_JuntaDirectiva').valueChanges();
    };
    /*
      FAQCategorias
    */
    DatabaseService.prototype.getFAQCategorias = function () {
        return this.afs.collection('FAQ_Categorias', function (ref) { return ref.orderBy('date_added'); }).snapshotChanges().map(function (changes) {
            return changes.map(function (a) {
                var data = a.payload.doc.data();
                var edit = false;
                var id = a.payload.doc.id;
    ...
    DatabaseService.prototype.updateFAQCategorias = function (data) {
        return this.afs.collection('FAQ_Categorias').doc(data.id).update({
            nombre: data.nombre
        });
    };
    DatabaseService.prototype.addFAQCategorias = function (data) {
        var id = this.afs.createId();
    ...
    DatabaseService.prototype.removeFAQCategorias = function (data) {
        return this.afs.collection('FAQ_Categorias').doc(data.id).delete();
    };
    DatabaseService.prototype.addFAQ = function (data, categoria) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01, step_02;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        data.id = this.afs.createId();
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('FAQs').doc(data.id).ref;
                        batch.set(step_01, data);
                        step_02 = this.afs.collection('FAQ_Categorias').doc(categoria.id).collection('FAQs').doc(data.id).ref;
                        batch.set(step_02, {
                            id: data.id,
    ...
    DatabaseService.prototype.getFAQs = function (id) {
        return this.afs.collection('FAQ_Categorias').doc(id).collection('FAQs').valueChanges();
    };
    DatabaseService.prototype.removeFAQ = function (id, categoria) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01, step_02;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('FAQs').doc(id).ref;
                        batch.delete(step_01);
                        step_02 = this.afs.collection('FAQ_Categorias').doc(categoria.id).collection('FAQs').doc(id).ref;
                        batch.delete(step_02);
                        return [4 /*yield*/, batch.commit()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
    ...
    DatabaseService.prototype.updateFAQ = function (data, categoria) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01, step_02;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    /* Boleto Turistico */
    DatabaseService.prototype.addBoletoTuristico = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Boleto_Turistico').doc(data.id).ref;
                        batch.set(step_01, data);
                        return [4 /*yield*/, batch.commit()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
    ...
    DatabaseService.prototype.getBoletosTuristicos = function () {
        return this.afs.collection('Boleto_Turistico').valueChanges();
    };
    DatabaseService.prototype.addMuseo = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Museos').doc(data.id).ref;
                        batch.set(step_01, data);
                        return [4 /*yield*/, batch.commit()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
    ...
    DatabaseService.prototype.addParques_Arqueologicos = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Parques_Arqueologicos').doc(data.id).ref;
                        batch.set(step_01, data);
                        return [4 /*yield*/, batch.commit()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
    ...
    DatabaseService.prototype.addSalidaViajeProgramado = function (viaje, data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var batch, step_01, step_02;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        batch = this.afs.firestore.batch();
                        step_01 = this.afs.collection('Viajes_Programados').doc(viaje.id).collection("Salidas").doc(data.id).ref;
                        batch.set(step_01, data);
                        step_02 = this.afs.collection('Viajes_Programados').doc(viaje.id).ref;
                        batch.update(step_02, {
                            disponible: true
                        });
                        return [4 /*yield*/, batch.commit()];
    ...
    DatabaseService.prototype.getSalidasViajeProgramado = function (id) {
        return this.afs.collection('Viajes_Programados').doc(id).collection("Salidas").valueChanges();
    };
    DatabaseService.ngInjectableDef = _angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵdefineInjectable"]({ factory: function DatabaseService_Factory() { return new DatabaseService(_angular_core__WEBPACK_IMPORTED_MODULE_8__["ɵɵinject"](_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_1__["AngularFirestore"])); }, token: DatabaseService, providedIn: "root" });
...
module.exports = __webpack_require__(/*! /home/alain/PuntoPro/DIRCETUR/src/main.ts */"./src/main.ts");
